...
def test_mask_account_card_invalid(invalid_input_str):
    mask_account_card(invalid_input_str)


@pytest.mark.parametrize('iso_date, expected', [('2023-12-31T15:30:00', '31.12.2023'), ('2024-02-29T00:00:00', '29.02.2024'), ('2023-05-07T10:00:00', '07.05.2023'), ('2000-01-01T00:00:00', '01.01.2000')])
